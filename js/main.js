...
function buildSolarSystem() {
  ...
  // 3 orbit circles at different radii
  const orbits = [105, 130, 155];
  orbits.forEach(r => {
  ...
  // Badge config: [id, orbitIndex, speed]
  const badges = [
    { id: 'badge0', orbitIdx: 0, speed: 0.55, startAngle: 0 },      // IT Support: inner, fast
    { id: 'badge1', orbitIdx: 1, speed: 0.35, startAngle: 120 },    // Music: middle, medium
    { id: 'badge2', orbitIdx: 2, speed: 0.25, startAngle: 240 },    // Photo: outer, slow
  ];
